...
# tests = list()
# tests.append( speak( [0,3,6], 2020) == 436 )
# tests.append( speak( [1,3,2], 2020) == 1 )
# tests.append( speak( [2,1,3], 2020) == 10 )
# tests.append( speak( [1,2,3], 2020) == 27 )
# tests.append( speak( [2,3,1], 2020) == 78 )
# tests.append( speak( [3,2,1], 2020) == 438 )
# tests.append( speak( [3,1,2], 2020) == 1836 )
# print(tests)
# print( sum(tests)==len(tests) )

test2 = speak([13,0,10,12,1,5,8], 2020)
print(test2)