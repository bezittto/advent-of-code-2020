...
def validate ( passwords ):
    ...
    for p in passwords:
        ...
        policyparts_p = policyparts[0].split('-')
        policyparts_p_a = int(policyparts_p[0])
        policyparts_p_b= int(policyparts_p[1])

        policyparts_letter = policyparts[1]

        passw = _[1]
        try:
            a_ = passw[policyparts_p_a-1]
            b_ = passw[policyparts_p_b-1]
            test1_ = a_ ==policyparts_letter
            test2_ = b_==policyparts_letter
            test_ = test1_ + test2_
            if test_ == 1: valid+=1 
        except:
            pass
